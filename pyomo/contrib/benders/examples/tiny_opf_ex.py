...
def create_tiny_opf(grid, mode=2):
    ...
    if mode == 0:
        ...
        model.NodesOut = pyo.Set(model.buses, initialize=grid.NodesOut_init)
        ...
        model.NodesIn = pyo.Set(model.buses, initialize=grid.NodesIn_init)
